%\cleardoublepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Angular analysis}\label{app:BsJpsiKst_angana}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Angular acceptance splitted by data-taking year periods}\label{app:BsJpsiKst_angana_accper}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bin1 neg kaons
\begin{table}[hbtp]
...
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Convergence of the iterative procedure}\label{app:BsJpsiKst_angana_itproc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bin1 pos kaons
\begin{table}[h!]
    \center\footnotesize
     \caption{\small Corrected angular acceptance weights for the simulated samples after each iteration. $1^{\text{st}}K\pi$ bin, positive kaons. The upper half of the table shows the value of each normalisation weight after each iteration. The iteration number is denoted by the column on the right. The two middle rows show the statistical uncertainty on each normalisation weight and the significance of its change defined as $(\xi_k^{\text{uncorr}} - \xi_k^{\text{final}})/\sigma_k^{\text{final}}$, respectivelly. The lower half of the table shows the change on the value of each normalisation weight after each iteration divided by its statistical error. This essentially shows the convergence of each weight. The normalisation weights converge when the changes gradually tend to zero. All the normalisation weights are normalised with respect to $\xi_{00}$.}      
...
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Normalisation weights}\label{app:BsJpsiKst_angana_final}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[hbtp]
\center\footnotesize
...
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Angular acceptance plots}\label{app:BsJpsiKst_angana_plots}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% pos kaons
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $1^{\text{st}}K\pi$ bin, positive kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_posKaons_bin1.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_posKaons_bin1.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_posKaons_bin1.pdf}   }
     \label{steady_state}
\end{figure}
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $2^{\text{ned}}K\pi$ bin, positive kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_posKaons_bin2.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_posKaons_bin2.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_posKaons_bin2.pdf}   }
     \label{steady_state}
\end{figure}
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $3^{\text{rd}}K\pi$ bin, positive kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_posKaons_bin3.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_posKaons_bin3.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_posKaons_bin3.pdf}   }
     \label{steady_state}
\end{figure}
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $4^{\text{th}}K\pi$ bin, positive kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_posKaons_bin4.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_posKaons_bin4.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_posKaons_bin4.pdf}   }
     \label{steady_state}
\end{figure}
% neg kaons
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $1^{\text{st}}K\pi$ bin, negative kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_negKaons_bin1.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_negKaons_bin1.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_negKaons_bin1.pdf}   }
     \label{steady_state}
\end{figure}
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $2^{\text{ned}}K\pi$ bin, negative kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_negKaons_bin2.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_negKaons_bin2.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_negKaons_bin2.pdf}   }
     \label{steady_state}
\end{figure}
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $3^{\text{rd}}K\pi$ bin, negative kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_negKaons_bin3.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_negKaons_bin3.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_negKaons_bin3.pdf}   }
     \label{steady_state}
\end{figure}
\begin{figure}[h]
     \caption{\small 2D projections of the 3D efficiency function $4^{\text{th}}K\pi$ bin, negative kaons. }  
     \subfloat{\hspace{-1.5cm}\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_cosThL_Sim08_3fb_hel_negKaons_bin4.pdf}}
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThK_phi_Sim08_3fb_hel_negKaons_bin4.pdf}   }
     \subfloat{\includegraphics[scale=0.3]{figs/BsJpsiKst/angularAcc/canv_cosThL_phi_Sim08_3fb_hel_negKaons_bin4.pdf}   }
     \label{steady_state}
\end{figure}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
